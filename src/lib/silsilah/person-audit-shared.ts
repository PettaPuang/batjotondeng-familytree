...
export function normalizeAuditValue(field: PersonAuditField, value: unknown) {
...
export function serializePersonAuditFields(
  person: Record<PersonAuditField, unknown>,
) {
